module lattice_boltzmann_OpenACC
    implicit none
...
end module lattice_boltzmann_OpenACC

program LatticeBoltzmannOpenACCMain
    use lattice_boltzmann_OpenACC
    use mpi
    implicit none
...
end program LatticeBoltzmannOpenACCMain